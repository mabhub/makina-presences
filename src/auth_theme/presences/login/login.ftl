            ...
            <#if realm.password>
                <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                    <div class="form-header">
                        <h2>Connexion</h2>
                        <p>Connecte toi à ton compte avec ton trigamme et mot de passe pour t’inscrire sur un poste.</p>
                    </div>
                    
                    <div class="inputs">
                        <#if !usernameHidden??>
                            <div class="${properties.kcFormGroupClass!} field">
                        ...
                        <div class="${properties.kcFormGroupClass!} field">
                            ...
                            <div class="${properties.kcInputGroup!} passwordInput" dir="ltr">
                                <input tabindex="3" id="password" class="${properties.kcInputClass!}" name="password" type="password" autocomplete="current-password"
                                    aria-invalid="<#if messagesPerField.existsError('username','password')>true</#if>"
                                />
                                <button class="${properties.kcFormPasswordVisibilityButtonClass!} show_password" type="button"  onclick="console.log("test")">
                                    <input type="checkbox" id="password_icon_btn"/>
                                    <label class="password_icon" for="password_icon_btn"
